...
const Dialog = ({ open, onClose, title, children, widthClass = "max-w-2xl" }) => {
  ...
  return createPortal(
    ...
    >
      <div
        className={`w-full ${widthClass} max-h-[92vh] flex flex-col rounded-2xl bg-white shadow-2xl relative animate-scale-up overflow-hidden`}
