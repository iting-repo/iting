...
const JobApplications = () => {
  ...
  // Mock Data
  const candidates = [
    { id: 1, name: 'Nguyễn Văn A', position: 'UI/UX Designer', exp: '3 Năm', edu: 'Đại học', date: '23 Jan, 2022', status: 'Pending', avatar: 'https://i.pravatar.cc/150?img=11' },
    { id: 2, name: 'Trần Thị B', position: 'UI/UX Designer', exp: '1 Năm', edu: 'Cao đẳng', date: '22 Jan, 2022', status: 'Reviewed', avatar: 'https://i.pravatar.cc/150?img=5' },
    { id: 3, name: 'Lê Văn C', position: 'UI/UX Designer', exp: '5 Năm', edu: 'Thạc sĩ', date: '20 Jan, 2022', status: 'Interview', avatar: 'https://i.pravatar.cc/150?img=3' },
    { id: 4, name: 'Phạm Thị D', position: 'UI/UX Designer', exp: 'Mới TN', edu: 'Đại học', date: '19 Jan, 2022', status: 'Rejected', avatar: 'https://i.pravatar.cc/150?img=9' },
  ];
                  ...
                  <tr key={candidate.id} className="hover:bg-blue-50/30 transition-colors group">
                     <td className="p-5">
                        <div className="flex items-center gap-4">
                           <img src={candidate.avatar} alt="Avatar" className="w-10 h-10 rounded-full object-cover border border-gray-200" />
                           <div>
                              <div 
                     ...
                     <td className="p-5 text-sm text-gray-600 font-medium">{candidate.exp}</td>
                     <td className="p-5 text-sm text-gray-600">{candidate.edu}</td>
                     <td className="p-5 text-sm text-gray-500">{candidate.date}</td>
                     <td className="p-5">
