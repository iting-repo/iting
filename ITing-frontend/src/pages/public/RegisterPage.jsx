      ...
      <div className="hidden lg:block w-[50%] relative bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})`, clipPath: "polygon(80px 0, 100% 0, 100% 100%, 0 100%)", marginLeft: "-1px" }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 pl-24 text-white">
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl flex-1 text-center"><BsPeopleFill className="mx-auto mb-2" size={20} /><div className="text-xl font-bold">{(stats.totalCandidates || 0).toLocaleString('vi-VN')}</div><div className="text-[10px] uppercase text-gray-300">Ứng viên</div></div>
          </div>
        </div>
      </div>
    </div>
