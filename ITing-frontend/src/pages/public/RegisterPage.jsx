...
const FacebookIcon = () => (
  ...
  >
    <path
      fill="#1877F2"
      d="M24,4C12.954,4,4,12.954,4,24c0,9.961,7.266,18.232,16.712,19.724V29.771H15.68V24h5.032v-4.367c0-4.965,2.951-7.705,7.474-7.705c2.166,0,4.432,0.387,4.432,0.387v4.872h-2.497c-2.46,0-3.228,1.526-3.228,3.091V24h5.489l-0.877,5.771h-4.612v13.953C36.734,42.232,44,33.961,44,24C44,12.954,35.046,4,24,4z"
    />
    <path
      fill="#fff"
      d="M30.419,24L31.296,29.771H26.684V43.724C25.803,43.868,24.909,44,24,44c-0.909,0-1.803-0.132-2.684-0.276V29.771H15.68V24h5.636v-4.367c0-4.965,2.951-7.705,7.474-7.705c2.166,0,4.432,0.387,4.432,0.387v4.872h-2.497c-2.46,0-3.228,1.526-3.228,3.091V24H30.419z"
    />
  </svg>
);
  ...
  return (
    <div className="h-screen flex bg-white font-sans">
      ...
      <div className="w-full lg:w-[50%] flex flex-col px-8 md:px-20 xl:px-32 relative z-10 h-full overflow-y-auto no-scrollbar py-12">
        ...
        <Link
          to="/"
          className="flex items-center gap-2 mb-8 w-fit hover:opacity-80 transition-opacity"
        >
        ...
        <div>
          ...
          <p className="text-[#6B7280] text-sm mb-6">
            Cùng tìm công việc IT chất lượng.
            <br />
            Bạn đã có tài khoản?{" "}
            <Link
              to="/login"
              className="text-[#3AB4E6] font-medium hover:underline"
            >
              Đăng nhập ngay
            </Link>
          </p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <input
                ...
                required
                placeholder={
                  role === "EMPLOYER" ? "Email công ty" : "Nhập email"
                }
                className="w-full px-5 py-3.5 bg-[#F0F5FA] border border-transparent rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
              />
            </div>
            ...
            {role === "EMPLOYER" && (
              <div className="space-y-4 p-4 bg-blue-50 rounded-lg border border-blue-100 mb-4 animate-fade-in-down">
                <p className="text-xs text-[#3AB4E6] font-semibold uppercase tracking-wide">
                  Chúng tôi sẽ dùng thông tin này để xác thực công ty
                </p>
                <div>
                  <input
                    type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-3 border border-gray-200 py-3 rounded-lg hover:bg-gray-50 transition font-medium text-gray-700"
            >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 pl-24 text-white">
          <h2 className="text-4xl font-bold leading-tight mb-8 drop-shadow-lg">
            Hơn <span className="text-blue-400">1,75,324</span> ứng viên đang
            tham gia để có công việc chất lượng.
          </h2>
          ...
          <div className="flex gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 p-4 rounded-xl flex-1 min-w-[140px]">
              ...
              <div className="text-[11px] text-gray-300 uppercase tracking-wide mt-1">
                Việc làm đang tuyển
              </div>
            </div>
