...
/**
 * Wire format for cross-instance WebSocket fan-out via Redis Pub/Sub. {@code originId} prevents the
 * publisher from re-delivering its own message locally.
 */
@Data
@Builder
@NoArgsConstructor
...
public class WsBroadcastEnvelope implements Serializable {
  ...
  public static WsBroadcastEnvelope toUser(
      String origin, String userId, String destination, Object payload) {
  ...
  public static String newOrigin() {
