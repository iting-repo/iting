...
public interface CompanyHrAffiliationRepository
    ...
    Optional<CompanyHrAffiliation> findByHrAccount_IdAndStatus(Long hrAccountId, AffiliationStatus status);

    /**
     * Affiliation đang active (INCOMPLETE/PENDING/APPROVED) của HR. Có tối đa 1 record
     * vì có partial unique index uniq_aff_active.
     */
    @Query("""
    ...
    Page<CompanyHrAffiliation> findBySubmissionStatus(SubmissionStatus submissionStatus, Pageable pageable);
