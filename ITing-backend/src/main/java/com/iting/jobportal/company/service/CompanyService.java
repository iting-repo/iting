...
public interface CompanyService {
    ...
    java.util.List<com.iting.jobportal.company.dto.request.CompanySocialLinkDto> getMySocialLinks(Long accountId);

    java.util.List<com.iting.jobportal.company.dto.request.CompanySocialLinkDto> updateMySocialLinks(Long accountId,
