...
public interface CompanyService {
  ...
  CompanyResponse updateRepresentativeByAccountId(
  ...
  CompanyResponse updateBusinessLicenseByAccountId(
      Long accountId, BusinessLicenseUploadRequest request);

  CompanyResponse updateConsentDocumentByAccountId(
  ...
  java.util.List<com.iting.jobportal.company.dto.request.CompanySocialLinkDto> getMySocialLinks(
      Long accountId);

  java.util.List<com.iting.jobportal.company.dto.request.CompanySocialLinkDto> updateMySocialLinks(
      Long accountId,
  ...
  String uploadLogoByAccountId(
      Long accountId, org.springframework.web.multipart.MultipartFile file);
