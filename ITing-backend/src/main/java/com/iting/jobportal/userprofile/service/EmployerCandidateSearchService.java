...
public interface EmployerCandidateSearchService {
  ...
  /**
   * Match ứng viên (chỉ những người openToWork=true) với job đã đăng, dùng job.jobEmbedding làm
   * query vector. Throws RuntimeException nếu job không tồn tại hoặc không thể embed.
   */
