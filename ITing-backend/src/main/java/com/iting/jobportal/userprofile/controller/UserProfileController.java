...
public class UserProfileController {
  ...
  public ResponseEntity<?> updateProfile(
      @CurrentUser Long userId, @Valid @RequestBody UserProfileUpdateDto dto) {
  ...
  public Education addEducation(
      @CurrentUser Long userId, @Valid @RequestBody EducationRequest req) {
  ...
  public Certificate addCertificate(
      @CurrentUser Long userId, @Valid @RequestBody CertificateRequest req) {
    return profileService.addCertificate(userId, req);
  }

  @PutMapping("/certificates/{id}")
  public ResponseEntity<?> updateCertificate(
      @PathVariable Long id, @Valid @RequestBody CertificateRequest req) {
  ...
  public Experience addExperience(
      @CurrentUser Long userId, @Valid @RequestBody ExperienceRequest req) {
  ...
  public Portfolio addPortfolio(
      @CurrentUser Long userId, @Valid @RequestBody PortfolioRequest req) {
    return profileService.addPortfolio(userId, req);
  }

  @PutMapping("/portfolio/{id}")
  public ResponseEntity<?> updatePortfolio(
      @PathVariable Long id, @Valid @RequestBody PortfolioRequest req) {
  ...
  public ResponseEntity<?> updateCVTitle(
  ...
  public SocialLink addSocialLink(
      @CurrentUser Long userId, @Valid @RequestBody SocialLinkRequest req) {
