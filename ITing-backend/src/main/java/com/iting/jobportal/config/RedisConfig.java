...
public class RedisConfig {
  ...
  /**
   * Build a Jackson mapper used ONLY for Redis (de)serialization. Must NOT be exposed as an {@code
   * ObjectMapper} bean — Spring Boot's {@code JacksonAutoConfiguration} backs off on
   * {@code @ConditionalOnMissingBean(ObjectMapper.class)}, so registering one here would replace
   * the MVC ObjectMapper and break request/response JSON.
   */
