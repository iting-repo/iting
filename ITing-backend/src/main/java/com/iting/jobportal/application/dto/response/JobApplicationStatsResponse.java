...
/**
 * Thống kê đơn ứng tuyển cho 1 job — admin dashboard. - employerResponded: số đơn nhà tuyển dụng đã
 * xử lý (status != PENDING). - successRate / rejectionRate: % trong tổng số đơn đã xử lý (loại
 * PENDING + WITHDRAWN).
 */
@Getter
@Setter
