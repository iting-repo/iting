...
public class KybReviewCompletedEvent implements DomainEvent {
    ...
    public static KybReviewCompletedEvent of(Long companyId, String decision, String note, Long reviewerId) {
        return KybReviewCompletedEvent.builder()
                .eventId(UUID.randomUUID().toString())
                .occurredAt(Instant.now())
                .companyId(companyId).decision(decision)
                .reviewerNote(note).reviewerAccountId(reviewerId)
                .build();
    }

    @Override public String eventId() { return eventId; }
    @Override public Instant occurredAt() { return occurredAt; }
    @Override public String aggregateKey() { return "company:" + companyId; }
}
