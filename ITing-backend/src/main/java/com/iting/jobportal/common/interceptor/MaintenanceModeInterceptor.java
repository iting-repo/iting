...
public class MaintenanceModeInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (cached != null && (now - cached.fetchTime) < CACHE_TTL_MS) {
            ...
            maintenanceMessage = config.getMaintenanceMessage() != null
    ...
    private void handleMaintenanceResponse(HttpServletRequest request, HttpServletResponse response,
            String maintenanceMessage) throws Exception {
