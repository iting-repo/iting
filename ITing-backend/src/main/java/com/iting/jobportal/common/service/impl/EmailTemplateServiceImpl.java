...
public class EmailTemplateServiceImpl implements EmailTemplateService {
    ...
    public String getOtpTemplate(String name, String otp, String purpose) {
        ...
        return buildWrapper(
                "<div style='text-align: center; padding: 20px;'>" +
                        ...
                        "  <p style='color: " + TEXT_COLOR + "; font-size: 16px; margin-bottom: 30px;'>Chào " + name
                        + ", vui lòng sử dụng mã dưới đây " + purposeText + ".</p>" +
                        ...
                        + BRAND_COLOR + ";'>" + otp + "</span>" +
                        "  </div>" +
                        "  <p style='color: " + FOOTER_COLOR
                        + "; font-size: 13px; margin-top: 30px;'>Mã này sẽ hết hạn sau 5 phút. Nếu bạn không thực hiện yêu cầu này, vui lòng bỏ qua email.</p>"
                        +
                        "</div>");
    }

    @Override
    public String getApplicationAcceptedTemplate(String candidateName, String jobTitle, String companyName,
            String actionUrl) {
        return buildWrapper(
                "<div>" +
                        "  <h1 style='color: " + BRAND_COLOR
                        ...
                        "    Chúng tôi rất vui mừng thông báo rằng nhà tuyển dụng <strong>" + companyName
                        ...
                        + "; font-size: 16px;'>Vui lòng truy cập hệ thống để xem các bước tiếp theo hoặc phản hồi lại nhà tuyển dụng.</p>"
                        +
                        "  <div style='text-align: center; margin: 40px 0;'>" +
                        "    <a href='" + actionUrl + "' style='background-color: " + BRAND_COLOR
                        + "; color: white; padding: 14px 28px; border-radius: 10px; text-decoration: none; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(58, 180, 230, 0.2);'>Xem chi tiết ứng tuyển</a>"
                        +
                        "  </div>" +
                        "  <p style='color: " + TEXT_COLOR
    ...
    @Override
    public String getApplicationRejectedTemplate(String candidateName, String jobTitle, String companyName,
            String reason) {
        String reasonHtml = "";
        if (reason != null && !reason.isBlank()) {
            reasonHtml = "<div style='background-color: #f9fafb; border-left: 4px solid #d1d5db; padding: 15px; margin: 20px 0; font-style: italic; color: #4b5563;'>"
                    + reason + "</div>";
        }
        ...
        return buildWrapper(
                "<div>" +
                        ...
                        "  <p style='color: " + TEXT_COLOR + "; font-size: 16px;'>Chào " + candidateName + ",</p>" +
                        "  <p style='color: " + TEXT_COLOR + "; font-size: 16px; line-height: 1.6;'>" +
                        "    Cảm ơn bạn đã quan tâm và dành thời gian ứng tuyển vào vị trí <strong>" + jobTitle
                        + "</strong> tại <strong>" + companyName + "</strong>." +
                        "  </p>" +
    ...
    private String buildWrapper(String content) {
        return "<!DOCTYPE html>" +
                ...
                "    .footer { padding: 30px; text-align: center; color: " + FOOTER_COLOR
                ...
                "      <p><a href='#' style='color: " + BRAND_COLOR
                + ";'>Điều khoản sử dụng</a> | <a href='#' style='color: " + BRAND_COLOR
