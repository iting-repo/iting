...
/**
 * HTTP client implementation for the Python ML microservice. Communicates via REST API with FastAPI
 * service. Gracefully degrades if ML service is unavailable (returns empty results).
 */
@Service
