...
/**
 * Knowledge Graph Service - Quản lý đồ thị kỹ năng IT.
 * Load từ file JSON (in-memory), cung cấp các phương thức mở rộng từ khóa
 * và giải thích matching giữa CV và JD.
 */
public interface KnowledgeGraphService {

    /**
     * Mở rộng từ khóa tìm kiếm bằng Knowledge Graph.
     * Ví dụ: "React" -> ["React", "JavaScript", "Frontend", "ReactJS", "Next.js"]
     *
    ...
    /**
     * Chuẩn hóa tên kỹ năng bằng synonym mapping.
     * Ví dụ: "JS" -> "javascript", "React.js" -> "react"
     *
    ...
    /**
     * Tính điểm phù hợp địa lý giữa địa điểm nhà tuyển dụng và ứng viên.
     * Dựa trên đồ thị vùng miền Việt Nam.
     *
