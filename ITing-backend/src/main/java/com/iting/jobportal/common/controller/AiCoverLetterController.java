...
public class AiCoverLetterController {
  ...
  public ResponseEntity<Map<String, String>> generateForJob(
    ...
    String candidateName =
        profile != null && profile.getFullName() != null ? profile.getFullName() : "Ứng viên";
    ...
    String coverLetter =
        geminiService.generateCoverLetter(candidateName, skillNames, bio, years, job);
  ...
  private int computeYearsOfExperience(UserProfile profile) {
    if (profile == null
        || profile.getWorkExperiences() == null
