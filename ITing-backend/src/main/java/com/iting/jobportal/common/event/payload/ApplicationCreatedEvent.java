...
public class ApplicationCreatedEvent implements DomainEvent {
    ...
    public static ApplicationCreatedEvent of(Long applicationId, Long jobId, Long candidateId, Long employerId) {
        return ApplicationCreatedEvent.builder()
                .eventId(UUID.randomUUID().toString())
                .occurredAt(Instant.now())
                .applicationId(applicationId).jobId(jobId)
                .candidateAccountId(candidateId).employerAccountId(employerId)
                .build();
    }

    @Override public String eventId() { return eventId; }
    @Override public Instant occurredAt() { return occurredAt; }
    @Override public String aggregateKey() { return "application:" + applicationId; }
}
