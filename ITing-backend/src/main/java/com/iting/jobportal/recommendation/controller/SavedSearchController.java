...
public class SavedSearchController {
  ...
  public ResponseEntity<SavedSearch> create(
    ...
    SavedSearch s =
        SavedSearch.builder()
            ...
            .emailAlertsEnabled(
                Boolean.TRUE.equals(body.get("emailAlertsEnabled"))
  ...
  public ResponseEntity<SavedSearch> update(
    ...
    if (body.containsKey("experienceLevel"))
      s.setExperienceLevel(asString(body.get("experienceLevel"), null));
            ...
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Saved search không tồn tại"));
