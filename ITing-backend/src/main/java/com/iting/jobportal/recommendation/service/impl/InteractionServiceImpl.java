...
public class InteractionServiceImpl implements InteractionService {
  ...
  public void trackInteraction(Long userId, Long jobId, InteractionType type) {
    ...
    try {
      ...
      if (account != null && job != null) {
        UserJobInteraction interaction =
            UserJobInteraction.builder()
                .account(account)
                .job(job)
  ...
  public boolean hasEnoughBehavior(Long userId) {
    ...
    long totalApplies =
        interactionRepository.countByAccountIdAndType(userId, InteractionType.APPLY);
