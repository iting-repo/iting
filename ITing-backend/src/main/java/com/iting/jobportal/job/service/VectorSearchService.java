...
/**
 * Vector Search Service - Tìm kiếm ngữ nghĩa (semantic search) sử dụng Bi-Encoder embedding +
 * Cosine Similarity.
 */
public interface VectorSearchService {

  /**
   * Tìm kiếm job bằng semantic similarity. Embed query text -> so sánh cosine similarity với tất cả
   * job embeddings.
   *
