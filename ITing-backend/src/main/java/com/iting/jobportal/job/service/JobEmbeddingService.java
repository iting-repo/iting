...
/**
 * Service để tạo và quản lý embedding cho Job entities.
 * Sử dụng OpenAI text-embedding-3-small để biến JD thành vector.
 */
public interface JobEmbeddingService {

    /**
     * Tạo embedding cho một job dựa trên nội dung JD.
     * Lưu vào trường jobEmbedding của entity.
     *
    ...
    /**
     * Batch embed tất cả job chưa có embedding.
     * Dùng cho scheduled task chạy hàng đêm.
     *
