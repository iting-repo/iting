...
public interface NotificationRepository extends JpaRepository<Notification, Integer> {
       ...
       Page<Notification> findByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
       ...
       @Query("SELECT n FROM Notification n WHERE n.recipientId = :recipientId AND n.recipientType = :recipientType " +
                     "ORDER BY n.time DESC")
       List<Notification> findByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType);
        ...
        */
       @Query("SELECT n FROM Notification n WHERE n.recipientId = :recipientId AND n.recipientType = :recipientType " +
                     "AND n.isRead = false ORDER BY n.time DESC")
       Page<Notification> findUnreadByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType,
                     Pageable pageable);
       ...
       @Query("SELECT n FROM Notification n WHERE n.recipientId = :recipientId AND n.recipientType = :recipientType " +
                     "AND n.isRead = false ORDER BY n.time DESC")
       List<Notification> findUnreadByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType);
       ...
       Long countUnreadByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType);
        ...
        */
       @Query("SELECT n FROM Notification n WHERE n.recipientId = :recipientId AND n.recipientType = :recipientType " +
                     "AND n.type = :type ORDER BY n.time DESC")
       Page<Notification> findByRecipientIdAndRecipientTypeAndType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType,
        ...
        */
       @Query("SELECT n FROM Notification n WHERE n.recipientId = :recipientId AND n.recipientType = :recipientType " +
                     "AND n.time >= :startDate ORDER BY n.time DESC")
       List<Notification> findRecentByRecipientIdAndRecipientType(@Param("recipientId") Long recipientId,
                     @Param("recipientType") RecipientType recipientType,
