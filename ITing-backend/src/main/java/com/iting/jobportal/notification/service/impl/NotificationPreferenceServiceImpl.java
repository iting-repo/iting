...
public class NotificationPreferenceServiceImpl implements NotificationPreferenceService {
    ...
    public NotificationPreferenceDto getOrCreate(Long accountId) {
        NotificationPreference pref = repository.findById(accountId)
                .orElseGet(() -> createDefault(accountId));
    ...
    public NotificationPreferenceDto update(Long accountId, NotificationPreferenceDto dto) {
        ...
        if (dto.getApplicationUpdates() != null) pref.setApplicationUpdates(dto.getApplicationUpdates());
