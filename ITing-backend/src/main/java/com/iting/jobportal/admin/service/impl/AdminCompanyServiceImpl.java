...
public class AdminCompanyServiceImpl implements AdminCompanyService {
  ...
  public Page<CompanyResponse> getPendingReviewCompanies(int page, int size) {
    ...
    return companyRepository
        .findByCompanyReviewStatusOrDocumentReviewStatus(
            CompanyReviewStatus.PENDING_REVIEW, DocumentReviewStatus.PENDING_REVIEW, pageable)
        .map(companyMapper::toResponse);
  }

  @Override
  public List<com.iting.jobportal.admin.dto.response.KybNoteResponse> getCompanyKybNotes(
      Long companyId) {
    return companyKybNoteRepository.findByCompanyIdOrderByCreatedAtDesc(companyId).stream()
        .map(
            note ->
                com.iting.jobportal.admin.dto.response.KybNoteResponse.builder()
                    .id(note.getId())
  ...
  @Override
  public com.iting.jobportal.admin.dto.response.KybNoteResponse addCompanyKybNote(
      Long adminId,
      Long companyId,
    ...
    Company company =
        companyRepository
            .findById(companyId)
            .orElseThrow(() -> new RuntimeException("Company not found"));
    com.iting.jobportal.company.entity.CompanyKybNote note =
        new com.iting.jobportal.company.entity.CompanyKybNote();
  ...
  private void doApproveCompany(Long adminId, Long companyId, CompanyApprovalRequest request) {
    ...
    String oldStatus =
        company.getCompanyReviewStatus() != null ? company.getCompanyReviewStatus().name() : null;
  ...
  @Override
  @Transactional
  public void approveCompanyDocuments(
      Long adminId, Long companyId, CompanyApprovalRequest request) {
    Company company =
        companyRepository
            .findById(companyId)
            .orElseThrow(() -> new RuntimeException("Company not found"));
    ...
    String oldStatus =
        company.getDocumentReviewStatus() != null ? company.getDocumentReviewStatus().name() : null;
  ...
  @Override
  @Transactional
  public void requestCompanyResubmission(
      Long adminId, Long companyId, ReviewRejectRequest request) {
    Company company =
        companyRepository
            .findById(companyId)
            .orElseThrow(() -> new RuntimeException("Company not found"));
    ...
    try {
      notificationService.createNotification(
          CreateNotificationRequest.builder()
              ...
              .content(
                  "Công ty của bạn đã bị đình chỉ hoạt động. Lý do: "
                      + reason
  ...
  public void unsuspendCompany(Long adminId, Long companyId) {
    ...
    List<CompanyAuditLog> suspendLogs =
        companyAuditLogRepository.findTopByCompanyIdAndActionOrderByCreatedAtDesc(
            companyId, CompanyAuditAction.SUSPEND);
    ...
    try {
      notificationService.createNotification(
          CreateNotificationRequest.builder()
              ...
              .content(
                  "Công ty của bạn đã được gỡ đình chỉ và hoạt động trở lại bình thường. "
  ...
  @Override
  @Transactional
  public void bulkApproveCompanies(
      Long adminId, List<Long> companyIds, CompanyApprovalRequest request) {
    if (companyIds != null) {
  ...
  @Override
  @Transactional
  public void bulkRejectCompanies(
      Long adminId, List<Long> companyIds, ReviewRejectRequest request) {
    if (companyIds != null) {
      for (Long id : companyIds) {
  ...
  @Override
  @Transactional
  public void bulkSuspendCompanies(
      Long adminId, List<Long> companyIds, ReviewRejectRequest request) {
    if (companyIds != null) {
      for (Long id : companyIds) {
  ...
  public List<CompanyAuditLogResponse> getCompanyAuditLogs(Long companyId) {
    ...
    return companyAuditLogRepository.findByCompany_IdOrderByCreatedAtDesc(companyId).stream()
        .map(
            log ->
                CompanyAuditLogResponse.builder()
  ...
  private CompanyAuditLogResponse mapToResponse(
      com.iting.jobportal.admin.dto.response.CompanyAuditLogView view) {
  ...
  public List<CompanyAuditLogResponse> getAllCompanyAuditLogs(
    ...
    java.time.LocalDateTime fromDateTime =
        fromDate != null ? fromDate.atStartOfDay() : java.time.LocalDateTime.of(1970, 1, 1, 0, 0);
    ...
    return companyAuditLogRepository
        .findAllWithCompanyFiltered(action, companyId, fromDateTime, toDateTime)
        .stream()
  ...
  public java.io.ByteArrayInputStream getImportTemplate() {
    ...
    return com.iting.jobportal.common.excel.ExcelHelper.createTemplate(
        headers, "Company Import Template");
  }
}
