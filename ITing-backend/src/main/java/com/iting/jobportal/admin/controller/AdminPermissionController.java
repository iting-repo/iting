...
@Tag(
    name = "15. Admin Permission Management",
    description = "Per-user permission override management")
public class AdminPermissionController {
  ...
  public ResponseEntity<?> replaceOverrides(
      @PathVariable Long userId, @RequestBody Map<String, Boolean> overrides) {
    Long adminId = 1L;
  ...
  public ResponseEntity<?> deleteOverride(
      @PathVariable Long userId, @PathVariable String permissionKey) {
    Long adminId = 1L;
