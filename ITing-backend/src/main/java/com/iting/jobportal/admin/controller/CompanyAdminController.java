...
public class CompanyAdminController {
  ...
  public ResponseEntity<List<com.iting.jobportal.admin.dto.response.KybNoteResponse>>
      getCompanyKybNotes(@PathVariable Long id) {
  ...
  public ResponseEntity<Page<CompanyResponse>> filterCompanies(
    ...
    return ResponseEntity.ok(
        adminCompanyService.filterCompanies(
            status, verificationLevel, active, keyword, page, size));
  }

  @PostMapping("/{id}/approve")
  @Operation(summary = "Duyệt toàn bộ công ty (cũ)")
  public ResponseEntity<?> approveCompany(
      @PathVariable Long id, @RequestBody CompanyApprovalRequest request) {
  ...
  public ResponseEntity<Map<String, String>> viewCompanyBusinessLicense(@PathVariable Long id) {
    Long adminId = 1L;
  ...
  public ResponseEntity<Map<String, String>> viewCompanyConsentDocument(@PathVariable Long id) {
  ...
  public ResponseEntity<List<CompanyAuditLogResponse>> getCompanyAuditLogs(@PathVariable Long id) {
  ...
  public ResponseEntity<Resource> exportCompanies() {
    ...
    InputStreamResource file =
        new InputStreamResource(adminCompanyService.exportCompaniesToExcel());
