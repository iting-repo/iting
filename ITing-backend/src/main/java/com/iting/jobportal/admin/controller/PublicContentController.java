...
public class PublicContentController {
  ...
  public ResponseEntity<List<StaticContent>> getFAQs() {
    return ResponseEntity.ok(
        contentRepository.findByTypeAndPublishedOrderBySortOrderAsc("FAQ", true));
  }
  ...
  public ResponseEntity<List<StaticContent>> getBlogs() {
    return ResponseEntity.ok(
        contentRepository.findByTypeAndPublishedOrderBySortOrderAsc("BLOG", true));
  }
  ...
  public ResponseEntity<List<Category>> getIndustries() {
    return ResponseEntity.ok(
        categoryRepository.findByTypeAndActiveOrderBySortOrderAsc("INDUSTRY", true));
  }
  ...
  public ResponseEntity<List<Category>> getSkills() {
    return ResponseEntity.ok(
        categoryRepository.findByTypeAndActiveOrderBySortOrderAsc("SKILL", true));
  }
  ...
  public ResponseEntity<List<Category>> getLocations() {
    return ResponseEntity.ok(
        categoryRepository.findByTypeAndActiveOrderBySortOrderAsc("LOCATION", true));
  }
  ...
  public ResponseEntity<List<Category>> getCategoriesByType(@PathVariable String type) {
    return ResponseEntity.ok(
        categoryRepository.findByTypeAndActiveOrderBySortOrderAsc(type.toUpperCase(), true));
  }
