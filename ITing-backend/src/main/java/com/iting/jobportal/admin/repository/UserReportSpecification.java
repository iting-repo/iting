...
public class UserReportSpecification {
  public static Specification<UserReport> getReportsSpec(
      String status, String type, String targetType, String priority, String search) {
    return (root, query, criteriaBuilder) -> {
      ...
      if (search != null && !search.isEmpty()) {
        ...
        Predicate targetNamePredicate =
            criteriaBuilder.like(criteriaBuilder.lower(root.get("targetName")), searchPattern);
