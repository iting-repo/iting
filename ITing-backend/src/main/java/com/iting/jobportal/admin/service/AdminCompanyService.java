...
public interface AdminCompanyService {
  ...
  void bulkApproveCompanies(
      Long adminId, java.util.List<Long> companyIds, CompanyApprovalRequest request);

  void bulkRejectCompanies(
      Long adminId, java.util.List<Long> companyIds, ReviewRejectRequest request);

  void bulkSuspendCompanies(
      Long adminId, java.util.List<Long> companyIds, ReviewRejectRequest request);
