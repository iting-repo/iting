...
/**
 * EmployerJobController là deprecated dual-mount path (Phase 4). Same logic
 * with HrJobController. Test mỗi endpoint một sanity check thay vì duplicate
 * full coverage — đảm bảo dual-mount vẫn hoạt động sau refactor.
 */
