...
class UserAnnouncementControllerTest {
    ...
    void getActive_anonymous_userIdNull_returnsEmptyList() {
        ...
        verify(service, never()).getActiveForUser(org.mockito.ArgumentMatchers.any(),
    ...
    void getActive_authenticated_passesRoleAndRoute() {
        ...
        when(service.getActiveForUser(1L, "CANDIDATE", "/jobs")).thenReturn(List.of(new AnnouncementDto()));
