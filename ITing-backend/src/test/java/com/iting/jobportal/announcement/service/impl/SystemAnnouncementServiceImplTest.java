...
class SystemAnnouncementServiceImplTest {
  ...
  void ack_announcementNotFound_throws404() {
    ...
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> service.ack(1L, 5L));
  ...
  void ack_nullUserId_throws401() {
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> service.ack(null, 5L));
  ...
  void list_paginated_mapsDto() {
    ...
    Page<AnnouncementDto> result =
        service.list(org.springframework.data.domain.PageRequest.of(0, 10));
  ...
  void create_appliesDefaults() {
    ...
    when(repo.save(any(SystemAnnouncement.class)))
        .thenAnswer(
            inv -> {
    ...
    assertEquals(
        AnnouncementDisplayMode.MODAL_DISMISSIBLE, saved.getDisplayMode(), "Default displayMode");
  ...
  void update_notFound_throws404() {
    ...
    ResponseStatusException ex =
        assertThrows(
            ResponseStatusException.class, () -> service.update(5L, new AnnouncementDto()));
    assertEquals(HttpStatus.NOT_FOUND, ex.getStatusCode());
  }
