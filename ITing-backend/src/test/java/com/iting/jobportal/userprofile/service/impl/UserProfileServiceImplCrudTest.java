...
class UserProfileServiceImplCrudTest {
  ...
  void updateSkill_notFound_throws() {
    ...
    assertThrows(
        ResourceNotFoundException.class, () -> service.updateSkill(99L, new SkillRequest()));
  }
  ...
  void updateCVTitle_notFound_throws() {
    ...
    assertThrows(ResourceNotFoundException.class, () -> service.updateCVTitle(99L, "x"));
  }
  ...
  void setDefaultCV_notFound_throws() {
    ...
    assertThrows(ResourceNotFoundException.class, () -> service.setDefaultCV(1L, 99L));
  }
