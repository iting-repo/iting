...
class DomainNotificationPublisherTest {
  ...
  @InjectMocks private DomainNotificationPublisher publisher;
  ...
  class NotifyUserTests {
    ...
    void notifyUser_correctRecipientType() {
      ...
      publisher.notifyUser(
          1L, NotificationType.MESSAGE_NEW, "Hello!", "CONVERSATION", 5L, "/messages");
    ...
    void notifyUser_delegatesToService() {
      publisher.notifyUser(
          42L, NotificationType.JOB_NEW, "New job posted", "JOB", 100L, "/jobs/100");
