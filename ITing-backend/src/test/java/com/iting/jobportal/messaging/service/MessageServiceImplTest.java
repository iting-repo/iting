...
class MessageServiceImplTest {
  ...
  @Mock private DomainNotificationPublisher domainNotificationPublisher;
  ...
  class SendMessageTests {
    ...
    void sendMessage_existingConversation_success() {
      ...
      verify(domainNotificationPublisher)
          .notifyUser(
              eq(2L),
    ...
    void sendMessage_conversationNotFound_throwsException() {
      ...
      RuntimeException exception =
          assertThrows(RuntimeException.class, () -> messageService.sendMessage(sendRequest, 1L));
    ...
    void sendMessage_longContent_truncatesInNotification() {
      ...
      verify(domainNotificationPublisher)
          .notifyUser(anyLong(), any(), contentCaptor.capture(), any(), any(), any());
  ...
  class GetMessagesTests {
    ...
    void getMessagesByConversation_returnsPaginated() {
      ...
      verify(messageRepository)
          .findByConversationIdOrderByCreatedAtDesc(eq(1L), any(Pageable.class));
    }
  ...
  class MarkAsReadTests {
    ...
    void markMessageAsRead_notReceiver_throwsException() {
      ...
      RuntimeException exception =
          assertThrows(RuntimeException.class, () -> messageService.markMessageAsRead(1L, 999L));

      assertEquals(
          "Unauthorized: You are not the receiver of this message", exception.getMessage());
    }
    ...
    void markMessageAsRead_notFound_throwsException() {
      ...
      RuntimeException exception =
          assertThrows(RuntimeException.class, () -> messageService.markMessageAsRead(999L, 2L));
  ...
  class GetByIdTests {
    ...
    void getMessageById_notFound_throwsException() {
      ...
      RuntimeException exception =
          assertThrows(RuntimeException.class, () -> messageService.getMessageById(999L));
