...
class WebSocketNotificationServiceImplTest {
  ...
  void sendNotificationToRecipient_user_buildsTopic() {
    ...
    verify(messagingTemplate).convertAndSend("/topic/user/42/notifications", n);
  }
  ...
  void sendNotificationToRecipient_company_buildsTopic() {
    ...
    verify(messagingTemplate).convertAndSend("/topic/company/7/notifications", n);
  }
  ...
  void sendNotificationToRecipient_admin_buildsTopic() {
    ...
    verify(messagingTemplate).convertAndSend("/topic/admin/1/notifications", n);
  }
