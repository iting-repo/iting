...
class NotificationServiceImplTest {
  ...
  class CreateNotificationTests {
    ...
    void createNotification_success_sendsWebSocketNotification() {
      ...
      verify(webSocketNotificationService)
          .sendNotificationToRecipient(
              eq(1L), eq(RecipientType.USER), any(NotificationResponse.class));
    ...
    void createNotification_setsIsReadFalse() {
      ...
      when(notificationRepository.countUnreadByRecipientIdAndRecipientType(anyLong(), any()))
          .thenReturn(0L);
    ...
    void createNotification_companyRecipient_success() {
      ...
      when(notificationRepository.countUnreadByRecipientIdAndRecipientType(
              2L, RecipientType.COMPANY))
          .thenReturn(1L);
      ...
      verify(webSocketNotificationService)
          .sendNotificationToRecipient(eq(2L), eq(RecipientType.COMPANY), any());
    }
  ...
  class GetNotificationsTests {
    ...
    void getNotifications_returnsPaginated() {
      ...
      when(notificationRepository.findByRecipientIdAndRecipientType(
              eq(1L), eq(RecipientType.USER), any(Pageable.class)))
          .thenReturn(page);

      Page<NotificationResponse> result =
          notificationService.getNotifications(1L, RecipientType.USER, 0, 20);
    ...
    void getNotifications_negativePage_usesZero() {
      ...
      verify(notificationRepository)
          .findByRecipientIdAndRecipientType(eq(1L), eq(RecipientType.USER), any(Pageable.class));
    }
  ...
  class GetUnreadNotificationsTests {
    ...
    void getUnreadNotifications_returnsList() {
      ...
      List<NotificationResponse> result =
          notificationService.getUnreadNotifications(1L, RecipientType.USER);
  ...
  class MarkAllAsReadTests {
    ...
    void markAllAsRead_success_sendsZeroCount() {
      ...
      verify(notificationRepository)
          .markAllAsReadForRecipient(eq(1L), eq(RecipientType.USER), any(LocalDateTime.class));
      verify(webSocketNotificationService).sendUnreadCount(1L, RecipientType.USER, 0L);
    }
  }
  ...
  class GetByTypeTests {
    ...
    void getNotificationsByType_returnsFiltered() {
      ...
      when(notificationRepository.findByRecipientIdAndRecipientTypeAndType(
              ...
              eq(NotificationType.MESSAGE_NEW),
              any(Pageable.class)))
          .thenReturn(page);
