...
class AdminApplicationServiceImplEdgeCaseTest {
  ...
  @InjectMocks private AdminApplicationServiceImpl service;

  @Test
  void
      getAllSystemApplications_whenRepositoryReturnsEmptyPage_shouldReturnEmptyPageAndNotLoadForms() {
  ...
  void getAllSystemApplications_whenSentIdIsNull_shouldThrowNullPointerException() {
    ...
    assertThrows(NullPointerException.class, () -> service.getAllSystemApplications(0, 10));
  ...
  @Test
  void
      getAllSystemApplications_whenApplyFormIdIsNull_shouldPassNullToRepositoryThenThrowApplyFormNotFound() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> service.getAllSystemApplications(0, 10));
  ...
  void getAllSystemApplications_whenMapperThrows_shouldPropagateException() {
    ...
    IllegalStateException ex =
        assertThrows(IllegalStateException.class, () -> service.getAllSystemApplications(0, 10));
  ...
  void deleteApplication_whenJoinDeleteFails_shouldNotDeleteApplyForm() {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> service.deleteApplication(15L));

    assertEquals("Delete join failed", ex.getMessage());
    verify(adminApplicationRepository)
        .deleteById(any(ApplyFormSentToJob.ApplyFormSentToJobId.class));
  ...
  void deleteApplication_whenApplyFormDeleteFails_shouldPropagateExceptionAfterJoinDelete() {
    doThrow(new RuntimeException("Delete form failed")).when(applyFormRepository).deleteById(15L);
  ...
  @Test
  void
      deleteApplication_whenApplicationIdIsNull_shouldStillUseNullInCompositeKeyAndDeleteNullFormId() {
    ArgumentCaptor<ApplyFormSentToJob.ApplyFormSentToJobId> captor =
        ArgumentCaptor.forClass(ApplyFormSentToJob.ApplyFormSentToJobId.class);
  ...
  void getAllSystemApplications_whenPageOrSizeInvalid_shouldThrow() {
    assertThrows(IllegalArgumentException.class, () -> service.getAllSystemApplications(-1, 10));

    assertThrows(IllegalArgumentException.class, () -> service.getAllSystemApplications(0, 0));
