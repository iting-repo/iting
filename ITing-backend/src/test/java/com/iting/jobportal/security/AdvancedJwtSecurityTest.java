 ...
 *
 * <ul>
 *   <li>"alg: none" signature stripping
 *   <li>Algorithm confusion (HS256 ↔ RS256)
 *   <li>Empty signature
 *   <li>Reserved claim manipulation (iat, exp, nbf)
 *   <li>Long-payload DoS
 *   <li>Replay across boundaries
 * </ul>
 */
...
class AdvancedJwtSecurityTest {
  ...
  class AlgorithmNoneAttackTests {
    ...
    void validateToken_algNone_shouldReject() {
      ...
      assertFalse(
          jwtTokenUtil.validateToken(malicious),
  ...
  class ReservedClaimManipulationTests {
    ...
    void validateToken_extremelyFarExp_signatureRequired() {
      ...
      assertFalse(
          jwtTokenUtil.validateToken(unsignedAttack),
  ...
  class TokenIsolationTests {
    ...
    void generateToken_sameUserTwice_canMatchButShouldNotBypassExpiry()
      ...
      assertNotEquals(
          c1.getIssuedAt().getTime(),
          c2.getIssuedAt().getTime(),
    ...
    void getUserIdFromToken_isolatedPerToken() {
      ...
      assertNotEquals(
          jwtTokenUtil.getUserIdFromToken(tokenA), jwtTokenUtil.getUserIdFromToken(tokenB));
    }
  }
