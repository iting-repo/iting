...
class CompanyFollowServiceImplTest {
  ...
  @InjectMocks private CompanyFollowServiceImpl companyFollowService;
  ...
  void followCompany_whenAlreadyFollowing_shouldThrow() {
    ...
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> companyFollowService.followCompany(1L, 10L));
  ...
  void unfollowCompany_whenNotFollowing_shouldThrow() {
    ...
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> companyFollowService.unfollowCompany(1L, 10L));
  ...
  void followCompany_whenValid_shouldCreateNotificationAndFollowRelation() {
    ...
    ArgumentCaptor<UserFollowCompany> followCaptor =
        ArgumentCaptor.forClass(UserFollowCompany.class);
