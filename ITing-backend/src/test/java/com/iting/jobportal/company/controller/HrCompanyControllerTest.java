...
class HrCompanyControllerTest {
  ...
  void getCompany_otherCompany_throws403() {
    ...
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> controller.getCompany(99L, 20L));
  ...
  void viewBusinessLicense_otherCompany_throws403() {
    ...
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> controller.viewBusinessLicense(99L, 20L));
    assertEquals(HttpStatus.FORBIDDEN, ex.getStatusCode());
  }
  ...
  void getFollowerCount_otherCompany_throws403() {
    ...
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> controller.getFollowerCount(99L, 20L));
    assertEquals(HttpStatus.FORBIDDEN, ex.getStatusCode());
  }
}
