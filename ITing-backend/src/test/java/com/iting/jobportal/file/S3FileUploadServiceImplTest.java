...
class S3FileUploadServiceImplTest {
  ...
  @InjectMocks private S3FileUploadServiceImpl service;
  ...
  void generatePresignedUrl_withInvalidUrl_shouldThrow() {
    assertThrows(
        ...
        () -> service.generatePresignedUrl("https://example.com/file", 5));
  }
  ...
  void generatePresignedUrl_shouldExtractKeyAndPresign() throws Exception {
    ...
    String result =
        service.generatePresignedUrl(
            "https://my-bucket.s3.ap-southeast-1.amazonaws.com/avatar/file.png", 5);
