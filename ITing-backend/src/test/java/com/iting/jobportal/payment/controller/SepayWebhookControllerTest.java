...
class SepayWebhookControllerTest {
    ...
    void webhook_notMatched_returnsSuccessFalse() {
        ...
        when(sepayPaymentService.handleWebhook(org.mockito.ArgumentMatchers.anyString(),
                org.mockito.ArgumentMatchers.anyMap())).thenReturn(false);
    ...
    void webhook_missingAuthHeader_stillPassedToService() {
        ...
        when(sepayPaymentService.handleWebhook(org.mockito.ArgumentMatchers.isNull(),
                org.mockito.ArgumentMatchers.anyMap())).thenReturn(false);
