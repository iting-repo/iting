...
class S3ServiceImplTest {
    ...
    void uploadFile_emptyFile_throws() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> service.uploadFile(empty, "cvs"));
    }

    @Test
    void uploadFile_happyPath_keyFormatAndPut() throws IOException {
        MockMultipartFile f = new MockMultipartFile("file", "resume.pdf", "application/pdf", "data".getBytes());
    ...
    void getPreSignedUrl_happyPath_returnsSignedUrl() throws Exception {
        ...
        when(signed.url()).thenReturn(URI.create("https://s3.local/iting-bucket/x.pdf?sig=abc").toURL());
